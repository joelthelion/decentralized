...
class App:
    def __init__(self,root):
        ...
        self.root.bind("k",lambda e:self.move_cursor("up"))
        self.root.bind("j",lambda e:self.move_cursor("down"))
        self.root.bind("g",lambda e:like.invoke())
        self.root.bind("b",lambda e:dislike.invoke())
