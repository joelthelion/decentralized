...
if __name__ == '__main__':
    ...
    stories=sql.request("select url_md5,url,symbols from story where (not isnull(fetch_date)) and (isnull(rated_date) or addtime(rated_date,'%s 00:00:00') < now())" , rerate_delay)
